...
## セットアップ（CT データと正解ラベルの追加登録）

腹部 CT のサンプルデータ（Medical Segmentation Decathlon 由来、CC-BY-SA 4.0）が同梱されており、展開後すぐにお使いいただけます。
独自の CT データを追加する場合は、以下の手順で登録してください。
